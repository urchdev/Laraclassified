...
@if ($xPanel->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    <link rel="stylesheet" href="{{ asset('vendor/admin/plugins/datepicker/datepicker3.css') }}">
    @endpush
    ...
    @if ($field_language !== 'en')
        <script charset="UTF-8" src="{{ asset('vendor/admin/plugins/datepicker/locales/bootstrap-datepicker.'.$field_language.'.js') }}"></script>
    @endif
    <script>
		if (jQuery.ui) {
