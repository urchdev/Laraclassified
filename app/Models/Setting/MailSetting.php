	...
	public static function getFields($diskName)
	{
		$fields = [
			...
			[
				...
				'type'              => 'custom_html',
				'value'             => trans('admin.driver_mandrill_title'),
				'wrapperAttributes' => [
					'class' => 'col-md-12 mandrill',
				],
			],
			[
				'name'  => 'driver_mandrill_info',
				'type'  => 'custom_html',
				'value' => trans('admin.driver_mandrill_info'),
				'wrapperAttributes' => [
					'class' => 'col-md-12 mandrill',
				],
			],
...
function getDriverFields(driverEl) {
	...
	hideEl(document.querySelectorAll(".smtp, .mailgun, .postmark, .ses, .mandrill, .sparkpost, .sendmail"));
	...
	if (driverElValue === "mandrill") {
		showEl(document.querySelectorAll(".mandrill"));
	}
