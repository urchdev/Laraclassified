...
class MetaTagController extends PanelController
{
	public function setup()
	{
		...
		*/
		...
		$this->xPanel->addButtonFromModelFunction('top', 'reset_entries_btn', 'resetEntriesBtn', 'end');
	...
	/**
	 * Reset the entries (like after new installation)
	 *
	...
	public function resetEntries()
	{
		try {
			...
			$table = DB::getTablePrefix() . (new MetaTag())->getTable();
			...
			$message = trans('admin.reset_entries_success');
